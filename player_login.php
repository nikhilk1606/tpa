...
if (isset($_POST['login'])) {
    ...
    if ($num_rows > 0) {
        ...
        $_SESSION['id'] = $records['id'];
            ...
            header("location: sanction-player.php");
            exit;
        }
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form enctype="multipart/form-data" method="post" id="frm_testimonials" name="frm_testimonials" role="form">
                                    ...
                                    <a href="forgot_player.php" class="btn forgot-pass">Forgot Password</a>
                                    <hr>
                                    <p>Don't have an Account? <a href="player_registration.php">Click here to Sanction Player</a></p>
                                </form>
                            </div>
                        </div>
                    </div>
