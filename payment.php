...
<div class="col-xs-12 col-sm-12">
               <h4 class="red-text">Umpires have to pay $40 for Sanction </h4> 
      </div>
  ...
  <form class="form-horizontal" action="https://www.sandbox.paypal.com/cgi-bin/webscr" id="chkout-form" method="post" >
    <form class="form-horizontal" action="https://www.paypal.com/cgi-bin/webscr" id="chkout-form" method="post" >                
                          ...
                          <!--  <input type="hidden" name="business" value="mileybutler000-buyer-1@gmail.com"> -->
                           ...
                           <input type='hidden' name='return' value="http://tech599.com/~tech599/tech599.com/johnonk/the-players-association/v1/success.php">
