...
<div id="page-wrapper">
  ...
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-6">
      <h3>State Director's Profile </h3>
            ...
            <div class="col-xs-12 col-sm-12">
              <form enctype="multipart/form-data" method="post" id="frm_testimonials" name="frm_testimonials" role="form">
                    ...
                    <label for="fname">User Name<span class="red_star">*</span></label>
        						<input type="text" name="login_id" id="login_id" class="form-control" value="<?php echo $records2['login_id'];?>" readonly >
                </div>
