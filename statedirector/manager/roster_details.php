...
$sql3 = "SELECT * FROM `states` WHERE `id`=$state";
    ...
    $sql4 = "SELECT * from player_sanction WHERE `state`='$state1' AND `player_status`='1' order by id desc";
    $result4=mysqli_query($con,$sql4);
    $sql5="SELECT * FROM `rosters` WHERE 1 ";
...
<div id="page-wrapper" class="main-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-md-10 padding0 white-back">
            ...
            <ol class="breadcrumb">
              <li class="active"><h1><i class="fa fa-list" aria-hidden="true"></i> All Users List <!-- <a href="add_user.php" class="add-new-h2">Add New</a></h1> --> </li>
            </ol>
          ...
          <div class="col-sm-6"><input type="submit" name="submit" value="Search" class="form-control btn"></div>
                 </div>
            </form>
            <?php
            
                echo"<span><h1>$roster</h1></span>";
