                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <form enctype="multipart/form-data" method="post" id="frm_testimonials" name="frm_testimonials" role="form">
                                    ...
                                    <a href="forgotpassword.php" class="btn forgot-pass">Forgot Password</a>
                                    <hr>
                                    <p>Don't have an Account? <a href="state_director_registration.php">Click here to Register State Director</a></p>
                                </form>
                            </div>
                        </div>
                    </div>
