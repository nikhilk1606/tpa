                ...
                <div class="col-xs-12 col-sm-4 col-sm-offset-3">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="cart-right">
                            <a href="cart.php"><i class="fa fa-shopping-cart"> </i> <p>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="team_login.php" <?php if($page_name=="team_login.php" || $page_name=="team_registration.php"){?> class="active"<?php }?>>Team Membership</a></li>
                            <li><a href="player_login.php" <?php if($page_name=="player_login.php" || $page_name=="player_registration.php"){?> class="active"<?php }?>>Sanction Player</a></li>
                            <li><a href="umpire-membership.php" <?php if($page_name=="umpire-membership.php" || $page_name=="umpire_login.php" || $page_name=="umpire_registration.php"){?> class="active"<?php }?>>umpire membership</a></li>
                            <li><a href="statedirector/state_director_login.php" <?php if($page_name=="state_director_login.php" || $page_name=="state_director_registration.php"){?> class="active"<?php }?>>State Director</a></li>
														
                            <li><a href="#county-community.php" <?php if($page_name=="county-community.php"){?> class="active"<?php }?>>County Community</a></li>
                            <!-- <li><a href="login.php" <?php if($page_name=="login.php"){?> class="active"<?php }?>>Login</a></li> -->
                        </ul>
                    </div>
                </div>
            </nav>
    ...
    <!-- <div id="ctl00_ucLoggedin_LoggedInContainer" class="LoggedInContainer">
	    <div class="container">
	        <div class="col-md-3 col-sm-12">
	            <span id="ctl00_ucLoggedin_lblLoggedInName" class="LoggedInName">Welcome, User.</span>
	        </div>
	        <div class="col-md-9 col-sm-12">
	            <ul>
	                ...
	                <li><a id="ctl00_ucLoggedin_lbLogOut" class="LoggedInLink" href="logout.php">Log Out</a></li>
