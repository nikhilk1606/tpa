...
if(isset($_POST['login'])){
 ...
 $myup = mysql_query("update `admin` set `email`='".$_POST['email']."' , `password` = '".$_POST['password']."',`user_name`='".$_POST['user_name']."' where `id`=".$admin_ids);
                ...
                <div class="row">
                  <div class="col-lg-6">
					...
					<div class="form-group control-group">
						...
						<input type="text" name="user_name" id="user_name" class="form-control" value="<?php echo $records2['user_name'];?>" >
					</div>				   
                   <div class="form-group control-group">
