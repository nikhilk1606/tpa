...
if(isset($_POST['submit'])){
    $email=$_POST['email'];
    $sql="SELECT * FROM `team_sanction` WHERE `team_email`='$email' ";
    ...
    if ($num_rows > 0) {
        ...
        $message = '<html><head></head><body style="font: 12px Verdana; color:#000000">
                ...
                <br>
                <p>Your Email ID: <span style="color:black">' . $records['team_email'] . '</span></p>
                <p>Your password: <span style="color:black">' . $records['team_password'] . '</span></p>
                <br>
        ...
        echo "<script type='text/javascript'>window.location.href = 'forgot_team.php';</script>";
