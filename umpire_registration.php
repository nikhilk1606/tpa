  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12 dualwindow_left">
        <h3 class="text-center">Umpire Sanction Form</h3>
        <form method="post" action="payment.php" id="cform" name="cform" class="umpireform">
          <div class="row">
          
            <div class="col-sm-4">
              <div class="form-group">
                <label>Umpire First Name <span>*</span></label>                
                <input type="text" name="fname" id="fname" class="form-control" placeholder="Umpire First Name"></div>
            </div>
              <div class="col-sm-4">
              <div class="form-group">
                <label>Umpire Last Name <span>*</span></label>
                <input type="text" name="lname" id="lname" class="form-control" placeholder="Umpire Last Name">
                </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-12 text-center">
              <button class="btn btn-primary register-btn" name="submit" value="submit"  />Click here to Pay</button>
            </div> 
          </div>
        </form>
      </div>
