...
if (isset($_POST['login'])) {
    ...
    if ($num_rows > 0) {
        ...
        $_SESSION['u_id']=$records['id'];
            //header("location: user-home.php");
            header("location:umpire-membership.php");
            exit;
        }
        ...
        header("location: umpire_login.php");
        exit;
    }
}
?>
...
<html lang="en">
    <head>
        ...
        <title>Umpire Login | The Players Association</title>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <?php } ?>
                    <h3 class="text-center">Umpire Login </h3>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form enctype="multipart/form-data" method="post" id="frm_testimonials" name="frm_testimonials" role="form">
                                    ...
                                    <a href="forgot_umpire.php" class="btn forgot-pass">Forgot Password</a>
                                    <hr>
                                    <p>Don't have an Account? <a href="umpire_registration.php">Click here to Sanction Umpire</a></p>
                                </form>
                            </div>
                        </div>
                    </div>
